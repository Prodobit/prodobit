...
class CalibrationService {
  ...
  Future<CalibrationPlan> createCalibrationPlan(CreateCalibrationPlanRequest request) async {
  ...
  Future<List<CalibrationPlan>> getCalibrationPlans({
    ...
    return data.map((json) => CalibrationPlan.fromJson(json as Map<String, dynamic>)).toList();
  }

  /// Get calibration plans by asset ID
  Future<List<CalibrationPlan>> getCalibrationPlansByAssetId(String assetId) async {
    final response = await _apiClient.get<Map<String, dynamic>>(
  ...
  Future<CalibrationRecord> createCalibrationRecord(CreateCalibrationRecordRequest request) async {
    final response = await _apiClient.post<Map<String, dynamic>>(
  ...
  Future<List<CalibrationRecord>> getCalibrationRecords({
    ...
    final data = response['data'] as List<dynamic>;
    return data.map((json) => CalibrationRecord.fromJson(json as Map<String, dynamic>)).toList();
  }

  /// Get calibration records by plan ID
  Future<List<CalibrationRecord>> getCalibrationRecordsByPlanId(String planId) async {
    final response = await _apiClient.get<Map<String, dynamic>>(
      '/api/v1/calibration-plans/$planId/records',
    );
  ...
  Future<List<CalibrationRecord>> getCalibrationRecordsByAssetId(String assetId) async {
    final response = await _apiClient.get<Map<String, dynamic>>(
  ...
  Future<CalibrationRecord> completeCalibrationRecord(
    ...
    final response = await _apiClient.post<Map<String, dynamic>>(
      ...
      data: {
        ...
        if (beforeCalibrationValues != null) 'beforeCalibrationValues': beforeCalibrationValues,
        if (afterCalibrationValues != null) 'afterCalibrationValues': afterCalibrationValues,
        ...
        if (certificateIssueDate != null) 'certificateIssueDate': certificateIssueDate.toIso8601String(),
        if (certificateExpiryDate != null) 'certificateExpiryDate': certificateExpiryDate.toIso8601String(),
      },
    );
